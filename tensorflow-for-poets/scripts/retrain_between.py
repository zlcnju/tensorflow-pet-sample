...
def main(_):
  ...
  if FLAGS.env_type == "master" :
        tf_config_json = os.environ.get("master", "{}")
  if FLAGS.env_type == "worker1" :
      tf_config_json = os.environ.get("worker1", "{}")
  if FLAGS.env_type == "worker2" :
      tf_config_json = os.environ.get("worker2", "{}")
  if FLAGS.env_type == "ps1" :
      tf_config_json = os.environ.get("ps1", "{}")
...
if __name__ == '__main__':
  ...
  parser.add_argument(
      '--serve_model_path',
      type=str,
      default='/tmp/newmodel/between/1',
      help="""\
